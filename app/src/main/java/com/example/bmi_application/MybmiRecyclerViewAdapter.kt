...
import com.example.bmi_application.bmiListFragment.OnListFragmentInteractionListener
...
class MybmiRecyclerViewAdapter(
    ...
    private val mListener: bmiListFragment.OnListFragmentInteractionListener?
) : RecyclerView.Adapter<MybmiRecyclerViewAdapter.ViewHolder>() {
